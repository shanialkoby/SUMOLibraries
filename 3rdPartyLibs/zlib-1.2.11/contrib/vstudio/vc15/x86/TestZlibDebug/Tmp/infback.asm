; Listing generated by Microsoft (R) Optimizing Compiler Version 19.12.25835.0 
	...
	TITLE	C:\Libraries\3rdPartyLibs\zlib-1.2.11\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG92532 DB	'invalid block type', 00H
	ORG $+1
$SG92537 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG92549 DB	'too many length or distance symbols', 00H
$SG92553 DB	'invalid code lengths set', 00H
	ORG $+3
$SG92564 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG92572 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG92575 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG92577 DB	'invalid literal/lengths set', 00H
$SG92579 DB	'invalid distances set', 00H
	ORG $+2
$SG92595 DB	'invalid literal/length code', 00H
$SG92607 DB	'invalid distance code', 00H
	ORG $+2
$SG92612 DB	'invalid distance too far back', 00H
	ORG $+2
$SG92146 DB	'1.2.11', 00H
_DATA	ENDS
CONST	SEGMENT
...
; File c:\libraries\3rdpartylibs\zlib-1.2.11\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG92146[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92532
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92537
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92549
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92553
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92564
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92572
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92575
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92577
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92579
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92595
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92607
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92612
