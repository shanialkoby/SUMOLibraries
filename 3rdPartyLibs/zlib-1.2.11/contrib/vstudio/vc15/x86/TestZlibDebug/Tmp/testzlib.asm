; Listing generated by Microsoft (R) Optimizing Compiler Version 19.12.25835.0 
	...
	TITLE	C:\Libraries\3rdPartyLibs\zlib-1.2.11\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG95162 DB	'rb', 00H
	ORG $+5
$SG95223 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG95226 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG95227 DB	'file %s read, %u bytes', 0aH, 00H
$SG95231 DB	'1.2.11', 00H
	ORG $+1
$SG95232 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG95233 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG95234 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG95235 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG95236 DB	'1.2.11', 00H
	ORG $+1
$SG95237 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG95238 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG95239 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG95240 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG95243 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; File c:\libraries\3rdpartylibs\zlib-1.2.11\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\program files (x86)\windows kits\10\include\10.0.16299.0\um\winnt.h
