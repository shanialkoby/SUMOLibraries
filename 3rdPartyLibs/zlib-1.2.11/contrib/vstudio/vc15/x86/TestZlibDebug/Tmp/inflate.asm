; Listing generated by Microsoft (R) Optimizing Compiler Version 19.12.25835.0 
	...
	TITLE	C:\Libraries\3rdPartyLibs\zlib-1.2.11\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG92204 DB	'1.2.11', 00H
	ORG $+1
$SG92764 DB	'incorrect header check', 00H
	ORG $+1
$SG92766 DB	'unknown compression method', 00H
	ORG $+1
$SG92770 DB	'invalid window size', 00H
$SG92774 DB	'unknown compression method', 00H
	ORG $+1
$SG92776 DB	'unknown header flags set', 00H
	ORG $+3
$SG92823 DB	'header crc mismatch', 00H
$SG92840 DB	'invalid block type', 00H
	ORG $+1
$SG92844 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG92856 DB	'too many length or distance symbols', 00H
$SG92860 DB	'invalid code lengths set', 00H
	ORG $+3
$SG92870 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG92876 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG92879 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG92881 DB	'invalid literal/lengths set', 00H
$SG92883 DB	'invalid distances set', 00H
	ORG $+2
$SG92897 DB	'invalid literal/length code', 00H
$SG92908 DB	'invalid distance code', 00H
	ORG $+2
$SG92918 DB	'invalid distance too far back', 00H
	ORG $+2
$SG92931 DB	'incorrect data check', 00H
	ORG $+3
$SG92936 DB	'incorrect length check', 00H
_DATA	ENDS
PUBLIC	_inflate@8
...
; File c:\libraries\3rdpartylibs\zlib-1.2.11\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 204  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG92204[edx]
	cmp	eax, ecx
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG92764
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG92766
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92770
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92774
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92776
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92823
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92840
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92844
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92856
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG92860
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92870
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92876
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG92879
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92881
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92883
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG92897
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG92908
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG92918
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92931
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG92936
